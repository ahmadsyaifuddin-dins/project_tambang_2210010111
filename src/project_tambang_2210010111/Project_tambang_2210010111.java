...
import tambang_model.*; // Mengimpor semua kelas pada package tambang_model 
...
//        coalDb.simpanCoal(7, date, "Wasi", 15, "Karat", "North Pit");
//        coalDb.updateCoal(6, date, "Belerang", 9, "Berbau", "North Pit");
//        coalDb.hapusCoal(7);
